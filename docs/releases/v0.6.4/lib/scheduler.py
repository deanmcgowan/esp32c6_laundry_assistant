...
def compute_recommendations(prices_cache, now_utc):
    ...
    appliances = [
        {"name": "Washing machine", "duration_s": 60 * 60, "delay_mins": _delay_options_washer(12), "assumed_kwh": 1.0},
        {"name": "Dishwasher", "duration_s": 60 * 60, "delay_mins": _delay_options_hourly(12), "assumed_kwh": 1.0},
        {"name": "Dryer", "duration_s": 4 * 60 * 60, "delay_mins": _delay_options_hourly(12), "assumed_kwh": 2.5},
    ]
        ...
        results.append(
            {
                ...
                "recommended_start_local": _fmt_stockholm_hm(best["start"]),  # keep existing key
                "recommended_start": pack_time(best["start"]),               # new normalized time
                "avg_price_now_sek_per_kwh": _r2(base_avg),
